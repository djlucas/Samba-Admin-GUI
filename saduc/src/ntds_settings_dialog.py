...
from samba_backend import get_ntds_settings, get_query_policies, get_replication_connections, format_ldap_guid, BASE_DN, get_base_dn
...
class NtdsSettingsDialog(QDialog):
    ...
    def _create_widgets(self):
        ...
        icon_path = os.path.join(os.path.dirname(__file__), 'res', 'icons', 'site_settings.png')
        self.header_icon.setPixmap(QIcon(icon_path).pixmap(32, 32))
